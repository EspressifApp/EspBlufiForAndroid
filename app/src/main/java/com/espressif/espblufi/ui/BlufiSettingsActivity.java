...
import com.espressif.blufi.communiation.BlufiProtocol;
...
public class BlufiSettingsActivity extends AppCompatActivity {
    ...
    public static class BlufiSettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mShared = getActivity().getSharedPreferences(BlufiConstants.PREF_SETTINGS_NAME, Context.MODE_PRIVATE);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                ...
                int mtuLen = mShared.getInt(BlufiConstants.PREF_SETTINGS_KEY_MTU_LENGTH, BlufiConstants.DEFAULT_MTU_LENGTH);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            if (preference == mMtuPref) {
                ...
                mMtuPref.setSummary(String.valueOf(mtuLen));
                mShared.edit().putInt(BlufiConstants.PREF_SETTINGS_KEY_MTU_LENGTH, mtuLen).apply();
            }
            return false;
        }
